...
y = Genius(
    "JVv8pud-25QRBYyRwcH34AlAygySsSAU3owRNGBw6hXO96x0JiTMn-3R4PvsjcTf",
    skip_non_songs=True,
...
async def lrsearch(client, message: Message, _):
    ...
    upl = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(text=_["L_B_1"], url=f"https://t.me/{app.username}?start=lyrics_{ran_hash}"),
            ]
        ]
    )
