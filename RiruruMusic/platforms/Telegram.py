...
from RiruruMusic.utils.formatters import convert_bytes, get_readable_time, seconds_to_min
...
class TeleAPI:
    def __init__(self):
        ...
        self.sleep = TELEGRAM_DOWNLOAD_EDIT_SLEEP
...
**ᴇᴛᴀ :** {eta}"""
                    try:
                        ...
                        pass
                    left_time[message.message_id] = datetime.now() + timedelta(seconds=self.sleep)
            ...
            try:
                ...
                await mystic.edit_text("**ғɪʟᴇ sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ.\n\n ᴩʀᴏᴄᴇssɪɴɢ...**")
