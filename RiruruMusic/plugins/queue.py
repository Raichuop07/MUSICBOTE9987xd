...
from config import (BANNED_USERS, YOUTUBE_IMG_URL, MUSIC_BOT_NAME,
                    TELEGRAM_AUDIO_URL, TELEGRAM_VIDEO_URL,
                    STREAM_IMG_URL, SOUNCLOUD_IMG_URL)
...
from RiruruMusic import app, YouTube
from RiruruMusic.misc import db
from RiruruMusic.utils.inline import queue_back_markup, queue_markup
from RiruruMusic.utils.decorators.language import language, languageCB
from RiruruMusic.utils import Altbin, get_channeplayCB, seconds_to_min
from RiruruMusic.utils.database import get_cmode, is_active_chat, is_music_playing
