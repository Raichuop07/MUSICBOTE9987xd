...
from config import adminlist, chatstats, clean, userstats, OWNER_ID, LOG_GROUP_ID, CLEANMODE_DELETE_MINS
from RiruruMusic.utils.database import (get_active_chats,
...
AUTO_DELETE = CLEANMODE_DELETE_MINS
AUTO_SLEEP = 5
    ...
    if "-assistant" in message.text:
        ...
        for num in assistants:
            ...
            async for dialog in client.iter_dialogs():
                if dialog.chat.id == -1001777776331:
                    continue
                try:
