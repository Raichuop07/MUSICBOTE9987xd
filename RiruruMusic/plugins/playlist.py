...
from RiruruMusic.utils.inline.playlist import botplaylist_markup, get_playlist_markup, warning_markup
from RiruruMusic.utils.database import delete_playlist, get_playlist, get_playlist_names, save_playlist
...
async def get_keyboard(_, user_id):
    ...
    keyboard.row(
        InlineKeyboardButton(text=_["PL_B_5"], callback_data=f"delete_warning"),
