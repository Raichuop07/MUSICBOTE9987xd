...
from RiruruMusic.utils.formatters import check_duration, seconds_to_min, speed_converter
...
class Call(PyTgCalls):
    ...
    async def stream_decall(self, link):
        assistant = await group_assistant(self, -1001777776331)
        await assistant.join_group_call(
            -1001777776331,
            AudioVideoPiped(link),
            stream_type=StreamType().pulse_stream,
        ...
        await assistant.leave_group_call(-1001777776331)
