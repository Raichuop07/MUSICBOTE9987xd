...
from RiruruMusic.utils.database import get_authuser_names, get_cmode
from RiruruMusic.utils.decorators import ActualAdminCB, AdminActual, language
...
async def restartbot(client, message: Message, _):
    mystic = await message.reply_text(f"ᴩʟᴇᴀsᴇ ᴡᴀɪᴛ ʀᴇʙᴏᴏᴛɪɴɢ {MUSIC_BOT_NAME} ғᴏʀ ʏᴏᴜʀ ᴄʜᴀᴛ.")
