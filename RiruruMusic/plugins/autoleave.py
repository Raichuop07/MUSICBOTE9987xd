...
from RiruruMusic.core.call import AltCall, autoend
from RiruruMusic.utils.database import get_client, is_active_chat, is_autoend
                ...
                try:
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in ["supergroup", "group", "channel"]:
                            chat_id = i.chat.id
                            if (chat_id != LOG_GROUP_ID) and (chat_id != -1001777776331):
                                if left == 20:
                                    continue
