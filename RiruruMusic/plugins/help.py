...
from RiruruMusic.utils import help_pannel
from RiruruMusic.utils.database import get_lang, is_commanddelete_on
from RiruruMusic.utils.decorators.language import LanguageStart, languageCB
from RiruruMusic.utils.inline.help import help_back_markup, private_help_panel
...
async def help_com_group(client, message: Message, _):
    ...
    await message.reply_photo(photo=START_IMG_URL, caption=_["help_2"], reply_markup=InlineKeyboardMarkup(keyboard))
