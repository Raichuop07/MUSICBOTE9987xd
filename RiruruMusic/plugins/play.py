...
from RiruruMusic.utils.logger import play_logs
from RiruruMusic.utils.formatters import formats
from RiruruMusic.utils.stream.stream import stream
from RiruruMusic.utils.database import is_video_allowed
from RiruruMusic.utils.decorators.play import PlayWrapper
from RiruruMusic.utils.channelplay import get_channeplayCB
from RiruruMusic.utils.decorators.language import languageCB
from RiruruMusic.utils import seconds_to_min, time_to_seconds
from RiruruMusic.utils.inline.playlist import botplaylist_markup
from RiruruMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from RiruruMusic.utils.inline.play import livestream_markup, playlist_markup, slider_markup, track_markup
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                ...
                return await app.send_message(config.LOG_GROUP_ID, "ᴩʟᴇᴀsᴇ ᴛᴜʀɴ ᴏɴ ᴠɪᴅᴇᴏᴄʜᴀᴛ ᴛᴏ sᴛʀᴇᴀᴍ ᴜʀʟ.")
            except Exception as e:
                return await mystic.edit_text(
