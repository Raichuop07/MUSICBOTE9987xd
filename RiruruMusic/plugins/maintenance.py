...
from RiruruMusic.utils.database import get_lang, is_maintenance, maintenance_off, maintenance_on
...
async def maintenance(client, message: Message):
    ...
    if state == "enable":
        ...
        if await is_maintenance() is False:
            ...
            await message.reply_text("ɪ ᴅᴏɴ'ᴛ ʀᴇᴍᴇᴍʙᴇʀ ᴛʜᴀᴛ ʏᴏᴜ ᴇɴᴀʙʟᴇᴅ ᴍᴀɪɴᴛᴇɴᴀɴᴄᴇ ᴍᴏᴅᴇ.")
    else:
