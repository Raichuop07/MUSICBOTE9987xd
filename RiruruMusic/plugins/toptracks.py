...
from RiruruMusic.utils.database import get_global_tops, get_particulars, get_userss
from RiruruMusic.utils.inline.playlist import botplaylist_markup, failed_top_markup, top_play_markup
